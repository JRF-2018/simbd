#!/usr/bin/python3
__version__ = '0.0.7' # Time-stamp: <2021-08-16T23:18:01Z>
...
from simbdp2.base import ARGS, Person0
from simbdp2.common import np_clip, np_random_choice, Child, Dissolution
