#!/usr/bin/python3
__version__ = '0.0.4' # Time-stamp: <2022-01-07T20:38:43Z>
...
from simbdp3x1.base import ARGS, Person0, EconomyPlot0
from simbdp3x1.common import np_clip, Child, Marriage, Adultery, Rape, \
    Pregnancy, Wait
from simbdp3x1.random import half_normal_rand, negative_binominal_rand
