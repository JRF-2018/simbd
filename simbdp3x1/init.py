#!/usr/bin/python3
__version__ = '0.0.1' # Time-stamp: <2021-09-25T22:27:25Z>
## Language: Japanese/UTF-8

"""Simulation Buddhism Prototype No.3 x.1 - Initialize
...
from simbdp3x1.random import negative_binominal_rand, right_triangular_rand,\
    half_normal_rand, adultery_term_rand
from simbdp3x1.common import np_clip, Adultery, Marriage, Child, Wait, \
    Pregnancy, MeanAmplifier, BlockMeanAmplifier
from simbdp3x1.domination import initialize_nation, Nation, District
...
def initialize (economy):
    ...
    initialize_mean_amplifiers(economy)


def initialize_mean_amplifiers (economy):
    economy.virtual_hating_ma = MeanAmplifier()
    economy.real_hating_ma = MeanAmplifier()
    economy.education_crime_ma = MeanAmplifier()
    economy.vicious_crime_bma = BlockMeanAmplifier()
    for dist in economy.nation.districts:
        dist.priests_share_ma = MeanAmplifier(pointlen=12)
        dist.education_power_ma = MeanAmplifier()
