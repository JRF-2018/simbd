#!/usr/bin/python3
__version__ = '0.0.3' # Time-stamp: <2021-10-25T13:02:43Z>
## Language: Japanese/UTF-8

"""Simulation Buddhism Prototype No.3 x.1 - Calamity
...
from simbdp3x1.base import ARGS, SerializableExEconomy
...
def calc_nation_parameters (economy):
    ...
    for dnum in range(len(ARGS.population)):
        ...
        y = dist.education_power_ma.update(ed)
