#!/usr/bin/python3
__version__ = '0.0.1' # Time-stamp: <2021-09-25T21:37:26Z>
## Language: Japanese/UTF-8

"""Simulation Buddhism Prototype No.3 x.1 - Base
...
class Person0 (Serializable):
    def __init__ (self):
        ...
        self.jail = None       # 囚人として収監
        self.priesthood = None # 僧職
        self.karma = 0	       # カルマ または 業
